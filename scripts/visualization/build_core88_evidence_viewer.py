...
def load_core88_symbols():
    if not os.path.exists(CORE88_SYMBOLS_PATH):
        raise FileNotFoundError(f"Core 88 symbol config not found: {CORE88_SYMBOLS_PATH}")
    with open(CORE88_SYMBOLS_PATH, "r", encoding="utf-8") as f:
...
<head>
    <meta charset="UTF-8">
    <title>Core 88 Evidence Viewer</title>
...
<body>
    <div class="header">
        <h2>Core 88 Local Research Evidence Viewer</h2>
        <div class="controls">
            <div>
